...
{
		alert("Please Enter Your Date of birth D-M-S")
		form1.dob.focus()
		return false
		}
...
{
		alert("Please Enter Your Tenth Marks in numbers (%)")
		form1.ten.focus()
		return false
		}
...
{
		alert("Please Enter Your Twelth Marks in numbers (%)")
		form1.twe.focus()
		return false
		}
...
{
		alert("Please Enter Your Pin-Code in Numbers")
		form1.pin.focus()
		return false
		}
if ((form1.contect.value == "")||(form1.contect.value == null)||(isNaN(form1.contect.value)))
{
		alert("Please Enter Your Contect Number in Number")
		form1.contect.focus()
		return false
		}
...
<form name=form1 action='Resister.jsp?name=1'>
  ...
  <tr><td width='50%' height='10'><div align="right" class="style15">
        <%String cn=obj.coll();%><%application.setAttribute("sec",cn);   //important to note//
  String id=obj.id();
  ...
  </tr><tr><td height='13'><div align="right"><span class="style20 style2 style4 style11">DATE OF BIRTH:(D-M-S)</span>          
  ...
  <tr><td height='33'><div align="right"><span class="style20 style5"><strong>TENTH MARKS(%):</strong></span>          
        <input type='text' name='ten'>
  </div></td>
    <td height='33'>&nbsp;</td>
  </tr><tr><td height='48'><div align="right"><span class="style20 style5"><strong>TWELTH MARKS(%):</strong></span>          
