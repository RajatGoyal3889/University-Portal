...
out.println("<table bgcolor=''  bordercolor='' border='1'><td><form name='form1' method='' action='Admin2.jsp'><p><div align='right'>COURSE:&nbsp;&nbsp;&nbsp; <input type='text' name='course' value='"+courseold+"'></div></p><p><div align='left'>&nbsp;&nbsp;&nbsp;&nbsp;Degree/Deploma: <select name='type'><option value="+type+" selected>"+type+"</option><option>DEPLOMA</option><option>DEGREE</option></select></div></p><p><div align='left'>Eligible for Students:<select name='elig'><option value="+elig+" selected>"+elig+"</option><option>10 TH PASS</option><option>12 TH PASS</option><option>GRADUATE</option></select></div></p><p><div align='left'>Duration of Course:<select name='duera'><option value="+duera+" selected>"+duera+"</option><option>1 YEAR</option><option>2 YEAR</option><option>3 YEAR</option><option>4 YEAR</option><option>5 YEAR</option></select></div></p><p><div align='right'>Course Description: <input type='text' name='desc' value="+desc+"></div></p><p><div align='center'><input  type='submit' name='name' value= 'CONFIRM' onclick='return validationTxt()'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input  type='submit' name='name' value= 'Home' ></div></form></td></table>");
}
//**//CONFORM
...
PreparedStatement ps=c.prepareStatement("update Courses set Course=?,Type=?,Eligible=?,Duration=?,Description=?  where Course=?");
...
if(name.equals("ADD"))
{
//System.out.println("course= "+course+" type= "+type+" duration= "+duera+" elig= "+elig+" descp= "+desc);
