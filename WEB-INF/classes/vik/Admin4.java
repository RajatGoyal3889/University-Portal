...
out.println("<table bgcolor='' WIDTH='500'  bordercolor='' border='1'><td><form name='form1' method='' action='Admin4.jsp'><p><div align='CENTER'>Faculty :&nbsp;&nbsp;&nbsp; <input type='text' name='fname' value='"+fname+"'></div></p><p><div align='center'><p><div align='CENTER'>Address :&nbsp;&nbsp;&nbsp; <input type='text' name='fadd' value='"+fadd+"'></div></p><p><div align='CENTER'>Contact no. :&nbsp;&nbsp;&nbsp; <input type='text' name='fph' value='"+fph+"'></div></p><p><div align='CENTER'>Mail ID :&nbsp;&nbsp;&nbsp; <input type='text' name='fmail' value='"+fmail+"'></div></p><p><div align='CENTER'>Gender :&nbsp;&nbsp;&nbsp; <select name='fsex'><option value="+fsex+" selected>"+fsex+"</option><option>Male</option><option>Female</option></select></div></p><input  type='submit' name='name' value= 'CONFIRM' onclick='return validationTxt()'>&nbsp;&nbsp;<input  type='submit' name='name' value= 'BACK'>&nbsp;&nbsp;<input  type='submit' name='name' value= 'DELETE'>&nbsp;&nbsp;<input type='submit' name='name' value= 'Home'></div></form></td></table>");
