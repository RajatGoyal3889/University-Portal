...
ResultSet rs=st.executeQuery("SELECT * from Validroll where Validroll.Roll='"+txtRoll+"' and Validroll.Year='"+txtYear+"' and Validroll.Stream='"+txtCourseName+"' and Validroll.Sesion='"+txtSession+"'");
