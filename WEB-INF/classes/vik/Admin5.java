...
//important method for updating the result of any student by admin-->//
...
td=td+"<option>"+rs.getString(1)+"</option>";
 ...
 td=td+"</select></div></tr><tr><td><div align='center'>Session: <select name='session'><option>2010</option><option>2011</option><option>2012</option><option>2013</option><option>2014</option><option>2015</option></select>Year: <select name='year'><option>I</option><option>II</option><option>III</option><option>IV</option><option>V</option></select></div></td></tr><tr><td><div align='center'><input style='FONT-WEIGHT: bold' type='submit' value= 'NEXT'  ></div></td></tr></form></TABLE>";
out.println(td);
}
...
td=td+"</td></tr><tr><td><div align='center'>&nbsp;&nbsp;&nbsp;ROLL NUMBER:<input type='text' name='roll'></div></td></tr><tr><td><div align='center'>&nbsp;&nbsp;&nbsp;STUDENT NAME:<input type='text' name='student'></div></td></tr><tr><td><div align='center'>&nbsp;&nbsp;&nbsp;STUDENT RESULT:<select name='result'><option>PASS</option><option>FAIL</option></select></div></td></tr><tr><td><div align='center'>&nbsp;&nbsp;&nbsp;STUDENT DIVISION:<select name='division'><option>I</option><option>II</option><option>III</option><option>IV</option></select></div></td></tr><tr><td><div align='center'>&nbsp;&nbsp;&nbsp;&nbsp;<input style='FONT-WEIGHT: bold' type='submit' value= 'UPLOAD' onclick='return validationTxt()'>&nbsp;&nbsp;&nbsp;<INPUT style='FONT-WEIGHT: bold' type=reset value=Reset></td></tr></div></td></tr></form></TABLE>";
out.println(td);
Statement st=c.createStatement();
...
if(a==1)
{
out.println("ROLL NUMBER ALREADY EXIST TRY ANOTHER ROLL NUMBER");
}
